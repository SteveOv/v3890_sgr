...
class MagnitudeFitResidualsTimePlot(SingleMagnitudeTimePlot):
    ...
    Optionally the data may be overlaid with fitted slopes and an secondary ax with the residuals to the fit.
    """
    ...
    def __init__(self, plot_params: Dict):
        ...
        self._y_label_residuals = self._param("y_label_residuals", "Residuals [mag]")
